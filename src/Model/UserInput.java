...
public class UserInput {
    ...
    private Double selectedpreviousCropNCredit;
    ...
    public UserInput(Crop selectedCrop, variety_type selectedVarType, Soil selectedSoil, Double selectedexpectedYield,
                     Double selectedpreviousCropNCredit, IrrigationMethod selectedIrrigationMethod,
        ...
        this.selectedpreviousCropNCredit = selectedpreviousCropNCredit;
    ...
    public Double getSelectedpreviousCropNCredit() {
        return selectedpreviousCropNCredit;
    }
